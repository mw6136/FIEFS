...
class FIEFS_Output:
    ...
    def data_preferences(self, pin: src.input.FIEFS_Input) -> None:
        """
        This function is called in `FIEFS.py` and sets the data preferences
    ...
    def save_data(
        ...
        ----------
        pmesh : FIEFS_Array
            FIEFS_Array mesh which contains all of the mesh information
